                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex-shrink-0">
                        <a
                            ...
                            className="text-base xs:text-lg sm:text-xl font-bold bg-gradient-to-r from-[#a855f7] to-[#6366f1] bg-clip-text text-transparent"
                        >
                            <span className="hidden xs:inline">Migwara Portofolio</span>
                            <span className="xs:hidden">Migwara</span>
                        </a>
                    </div>
